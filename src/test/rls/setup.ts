...
export const testSupabaseUrl = process.env.BIKE_BIN_TEST_SUPABASE_URL ?? 'http://127.0.0.1:54321';
// These are the default local dev keys from `supabase start`, safe to hardcode
const ANON_KEY =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6ImFub24iLCJleHAiOjE5ODM4MTI5OTZ9.CRXP1A7WOeoJeXxjNni43kdQwgnWNReilDMblYTn_I0';
export const testSupabaseServiceRoleKey =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZS1kZW1vIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImV4cCI6MTk4MzgxMjk5Nn0.EGIM96RAZx35lJzdJsyH-qQwv8Hdp7fsn3W0YpN81IU';

export const adminClient = createClient(testSupabaseUrl, testSupabaseServiceRoleKey, {
...
export async function createTestUser(prefix = 'rls'): Promise<TestUser> {
  ...
  const anonClient = createClient(testSupabaseUrl, ANON_KEY, {
    auth: { autoRefreshToken: false, persistSession: false },
  });
  ...
  const client = createClient(testSupabaseUrl, ANON_KEY, {
    auth: { autoRefreshToken: false, persistSession: false },
    global: {
