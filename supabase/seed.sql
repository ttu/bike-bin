...
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ...
  ('d0000001-0006-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', NULL,                                   'Park Tool PCS-10.3 Stand',     'tool',      'stands',            'Park Tool',    'PCS-10.3',               'Portable repair stand. Folds flat, holds bikes up to 36kg.',                                'good',  'loaned',  '{borrowable}',              NULL, 30,   '3 days',       'Garage',       '3_to_5_years', NULL, NULL, (now() - interval '900 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '40 days',  now() - interval '3 days'),
...
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ...
  ('d0000001-0003-4000-8000-000000000002', 'a1b2c3d4-0002-4000-8000-000000000002', NULL,                                   'Lezyne Micro Floor Drive',     'tool',      'pumps',             'Lezyne',       'Micro Floor Drive HVG',  'Compact floor pump with gauge. Works with presta and schrader.',                            'good',  'stored',  '{borrowable}',              NULL, 10,   '1_week',       'Hallway',      '1_to_2_years', NULL, NULL, (now() - interval '365 days')::date, 'b0000001-0001-4000-8000-000000000002', 'all', now() - interval '45 days',  now() - interval '3 days'),
...
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ...
  ('d0000001-0004-4000-8000-000000000003', 'a1b2c3d4-0003-4000-8000-000000000003', 'c0000001-0001-4000-8000-000000000003', 'SKS Bluemels Fenders',         'accessory', 'fenders',           'SKS',          'Bluemels 45mm',          'Full-length clip-on fenders. Fit 700c wheels with tires up to 42mm.',                       'good',  'stored',  '{borrowable,donatable}',    NULL, 5,    '2_weeks',      'Basement',     '1_to_2_years', NULL, NULL, (now() - interval '300 days')::date, 'b0000001-0001-4000-8000-000000000003', 'all', now() - interval '15 days', now() - interval '2 days'),
...
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ('d0000001-0001-4000-8000-000000000004', 'a1b2c3d4-0004-4000-8000-000000000004', 'c0000001-0001-4000-8000-000000000004', 'Tubus Logo Rear Rack',         'accessory', 'bags_racks',        'Tubus',        'Logo Classic',           'Stainless steel rear rack. Rated for 40kg. Bombproof.',                                     'good',  'mounted', '{borrowable}',              NULL, 25,   '1_month',      NULL,           '3_to_5_years', 15000, 'km', (now() - interval '1200 days')::date, 'b0000001-0001-4000-8000-000000000004', 'all', now() - interval '60 days', now() - interval '20 days'),
