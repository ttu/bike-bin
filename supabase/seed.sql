...
INSERT INTO borrow_requests (id, item_id, requester_id, status, message, created_at, updated_at) VALUES
  ('f2000001-0001-4000-8000-000000000001', 'd0000001-0006-4000-8000-000000000001', 'a1b2c3d4-0006-4000-8000-000000000006', 'picked_up', 'Need the stand for a fork service this weekend.', now() - interval '5 days', now() - interval '4 days'),
  ...
  ('f2000001-0004-4000-8000-000000000001', 'd0000001-0009-4000-8000-000000000001', 'a1b2c3d4-0002-4000-8000-000000000002', 'picked_up', 'Need accurate pressure for race wheels.', now() - interval '3 days', now() - interval '2 days'),
