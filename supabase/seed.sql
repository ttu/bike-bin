...
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage_km, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ...
  ('d0000001-0006-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', NULL,                                   'Park Tool PCS-10.3 Stand',     'tool',      'stands',            'Park Tool',    'PCS-10.3',               'Portable repair stand. Folds flat, holds bikes up to 36kg.',                                'good',  'loaned',  '{borrowable}',              NULL, 30,   '3 days',       'Garage',       '3_to_5_years', NULL, (now() - interval '900 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '40 days',  now() - interval '3 days'),
...
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage_km, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ...
  ('d0000001-0004-4000-8000-000000000004', 'a1b2c3d4-0004-4000-8000-000000000004', 'c0000001-0001-4000-8000-000000000004', 'Brooks B17 Saddle',            'component', 'seatposts_saddles', 'Brooks',       'B17 Standard',           'Broken in perfectly over 10000km. Leather is supple but still supportive.',                 'worn',  'mounted', '{private}',                 NULL, NULL,  NULL,           NULL,           '5_plus_years', 10000, (now() - interval '1800 days')::date, 'b0000001-0001-4000-8000-000000000004', 'private', now() - interval '90 days', now() - interval '30 days'),
