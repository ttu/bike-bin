...
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage_km, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ('d0000001-0001-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', 'c0000001-0001-4000-8000-000000000001', 'Fox 36 Float Fork',            'component', 'suspension',        'Fox',          '36 Float Performance',   '160mm travel, 29er boost. Serviced 200km ago.',                                             'good',  'mounted', '{borrowable}',              NULL, 50,   '1_week',       NULL,           '6_to_12_months', 1200, 'km', (now() - interval '250 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '90 days',  now() - interval '10 days'),
  ('d0000001-0002-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', NULL,                                   'Maxxis Minion DHF/DHR Combo',  'component', 'tires_tubes',       'Maxxis',       'Minion DHF/DHR II 29x2.5', 'Front DHF + rear DHR II set. EXO+ casing, MaxxTerra. About 60% tread left.',               'worn',  'stored',  '{sellable,donatable}',      40,   NULL,  NULL,           'Garage shelf', '1_to_2_years', 2000, 'km', (now() - interval '400 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '30 days',  now() - interval '5 days'),
  ('d0000001-0003-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', NULL,                                   'Park Tool Chain Checker',      'tool',      'chain_tools',       'Park Tool',    'CC-3.2',                 'Chain wear indicator. Essential for bike maintenance.',                                      'good',  'stored',  '{borrowable}',              NULL, 5,    '1_week',       'Tool box',     '2_to_3_years', NULL, NULL, (now() - interval '730 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '90 days',  now() - interval '15 days'),
  ('d0000001-0004-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', NULL,                                   'Topeak Alien II Multi-tool',   'tool',      'multi_tools',       'Topeak',       'Alien II',               '26-function multi-tool. Great for trailside repairs.',                                      'good',  'stored',  '{borrowable}',              NULL, 5,    '7 days',       'Backpack',     '2_to_3_years', NULL, NULL, (now() - interval '600 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '60 days',  now() - interval '8 days'),
  ('d0000001-0005-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', NULL,                                   'Troy Lee Designs A3 Helmet',   'accessory', 'helmets',           'Troy Lee',     'A3 MIPS',                'Trail helmet, size M/L. MIPS, good ventilation. Got a new one.',                            'good',  'stored',  '{sellable}',                60,   NULL,  NULL,           'Closet',       '1_to_2_years', NULL, NULL, (now() - interval '350 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '25 days',  now() - interval '5 days'),
  ('d0000001-0006-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', NULL,                                   'Park Tool PCS-10.3 Stand',     'tool',      'work_stands',       'Park Tool',    'PCS-10.3',               'Portable repair stand. Folds flat, holds bikes up to 36kg.',                                'good',  'loaned',  '{borrowable}',              NULL, 30,   '3 days',       'Garage',       '3_to_5_years', NULL, NULL, (now() - interval '900 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '40 days',  now() - interval '3 days'),
  ('d0000001-0007-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', 'c0000001-0002-4000-8000-000000000001', 'RaceFace Turbine R Cranks',    'component', 'drivetrain',        'RaceFace',     'Turbine R 175mm',        'Alloy cranks, 30T direct mount ring. Swapped for carbon set.',                              'good',  'stored',  '{sellable,borrowable}',     65,   20,   '2_weeks',      'Garage shelf', '2_to_3_years', 3500, 'km', (now() - interval '600 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '20 days',  now() - interval '8 days'),
  ('d0000001-0008-4000-8000-000000000001', 'a1b2c3d4-0001-4000-8000-000000000001', NULL,                                   'Muc-Off Chain Lube',           'consumable','lubricants',        'Muc-Off',      'Wet Lube 120ml',         'About half bottle left. Works great in wet conditions.',                                    'good',  'stored',  '{donatable}',               NULL, NULL,  NULL,           'Shelf',        '6_to_12_months', NULL, NULL, (now() - interval '200 days')::date, 'b0000001-0001-4000-8000-000000000001', 'all', now() - interval '10 days',  now() - interval '3 days');

-- Marcus items (road cyclist)
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage_km, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ('d0000001-0001-4000-8000-000000000002', 'a1b2c3d4-0002-4000-8000-000000000002', 'c0000001-0001-4000-8000-000000000002', 'Shimano 105 Cassette',         'component', 'drivetrain',        'Shimano',      '105 CS-R7000',           '11-speed cassette, 11-28T. Lightly used for one season.',                                   'good',  'mounted', '{borrowable}',              NULL, 20,   '14 days',      NULL,           '1_to_2_years', 3200, 'km', (now() - interval '365 days')::date, 'b0000001-0001-4000-8000-000000000002', 'all', now() - interval '120 days', now() - interval '30 days'),
  ('d0000001-0002-4000-8000-000000000002', 'a1b2c3d4-0002-4000-8000-000000000002', NULL,                                   'Continental GP5000 Tires',     'component', 'tires_tubes',       'Continental',  'Grand Prix 5000',        'Set of two 700x25mm clincher tires. ~500 km on them, plenty of tread left.',                'good',  'stored',  '{sellable,donatable}',      35,   NULL,  NULL,           'Garage shelf', '6_to_12_months', 500, 'km', (now() - interval '180 days')::date, 'b0000001-0001-4000-8000-000000000002', 'all', now() - interval '60 days',  now() - interval '5 days'),
  ('d0000001-0003-4000-8000-000000000002', 'a1b2c3d4-0002-4000-8000-000000000002', NULL,                                   'Lezyne Micro Floor Drive',     'accessory', 'pumps',             'Lezyne',       'Micro Floor Drive HVG',  'Compact floor pump with gauge. Works with presta and schrader.',                            'good',  'stored',  '{borrowable}',              NULL, 10,   '1_week',       'Hallway',      '1_to_2_years', NULL, NULL, (now() - interval '365 days')::date, 'b0000001-0001-4000-8000-000000000002', 'all', now() - interval '45 days',  now() - interval '3 days'),
  ('d0000001-0004-4000-8000-000000000002', 'a1b2c3d4-0002-4000-8000-000000000002', 'c0000001-0001-4000-8000-000000000002', 'Fizik Antares R5 Saddle',      'component', 'seatposts_saddles', 'Fizik',        'Antares R5',             'Replaced with a different width. This is 143mm, regular flex.',                             'worn',  'stored',  '{donatable}',               NULL, NULL,  NULL,           'Garage shelf', '3_to_5_years', 8000, 'km', (now() - interval '1095 days')::date, 'b0000001-0001-4000-8000-000000000002', 'all', now() - interval '30 days', now() - interval '1 day'),
  ('d0000001-0005-4000-8000-000000000002', 'a1b2c3d4-0002-4000-8000-000000000002', NULL,                                   'Shimano SPD-SL Cleats',        'accessory', 'pedals',            'Shimano',      'SM-SH11',                'Yellow 6-degree float cleats, brand new in package. Bought extra pair by mistake.',         'new',   'stored',  '{sellable}',                12,   NULL,  NULL,           'Drawer',       NULL,           0,    'km', (now() - interval '14 days')::date,  'b0000001-0001-4000-8000-000000000002', 'all', now() - interval '10 days', now() - interval '10 days'),
  ('d0000001-0006-4000-8000-000000000002', 'a1b2c3d4-0002-4000-8000-000000000002', 'c0000001-0002-4000-8000-000000000002', 'Zipp Service Course Handlebar','component', 'handlebars_stems',  'Zipp',         'Service Course SL-70',   '42cm compact drop bar. Alloy, 31.8mm clamp. Removed during fit change.',                    'good',  'stored',  '{sellable,borrowable}',     40,   15,   '2_weeks',      'Garage shelf', '2_to_3_years', 5000, 'km', (now() - interval '800 days')::date, 'b0000001-0001-4000-8000-000000000002', 'all', now() - interval '20 days', now() - interval '8 days');

-- Sarah items (commuter)
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage_km, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ('d0000001-0001-4000-8000-000000000003', 'a1b2c3d4-0003-4000-8000-000000000003', 'c0000001-0001-4000-8000-000000000003', 'Brompton Front Carrier Block', 'accessory', 'bags_panniers',     'Brompton',     'Front Carrier Block',    'Standard front carrier block for Brompton bags. Came with bike, switched to aftermarket.',  'good',  'stored',  '{sellable,donatable}',      8,    NULL,  NULL,           'Drawer',       '1_to_2_years', NULL, NULL, (now() - interval '365 days')::date, 'b0000001-0001-4000-8000-000000000003', 'all', now() - interval '50 days', now() - interval '8 days'),
  ('d0000001-0002-4000-8000-000000000003', 'a1b2c3d4-0003-4000-8000-000000000003', NULL,                                   'Kryptonite Evolution Mini-7',  'accessory', 'locks',             'Kryptonite',   'Evolution Mini-7',       'Compact U-lock with flex cable. Sold Secure Gold rated.',                                   'good',  'stored',  '{borrowable}',              NULL, 20,   '1_week',       'Hallway',      '2_to_3_years', NULL, NULL, (now() - interval '600 days')::date, 'b0000001-0001-4000-8000-000000000003', 'all', now() - interval '35 days', now() - interval '5 days'),
  ('d0000001-0003-4000-8000-000000000003', 'a1b2c3d4-0003-4000-8000-000000000003', NULL,                                   'Busch+Mueller IQ-X Light',     'accessory', 'lights',            'Busch+Mueller','IQ-X',                   '100 lux dynamo front light. Amazing beam pattern. Upgrading to IQ-X E.',                    'good',  'stored',  '{sellable}',                45,   NULL,  NULL,           'Shelf',        '2_to_3_years', NULL, NULL, (now() - interval '500 days')::date, 'b0000001-0001-4000-8000-000000000003', 'all', now() - interval '20 days', now() - interval '3 days'),
  ('d0000001-0004-4000-8000-000000000003', 'a1b2c3d4-0003-4000-8000-000000000003', 'c0000001-0001-4000-8000-000000000003', 'SKS Bluemels Fenders',         'component', 'fenders',           'SKS',          'Bluemels 45mm',          'Full-length clip-on fenders. Fit 700c wheels with tires up to 42mm.',                       'good',  'stored',  '{borrowable,donatable}',    NULL, 5,    '2_weeks',      'Basement',     '1_to_2_years', NULL, NULL, (now() - interval '300 days')::date, 'b0000001-0001-4000-8000-000000000003', 'all', now() - interval '15 days', now() - interval '2 days'),
  ('d0000001-0005-4000-8000-000000000003', 'a1b2c3d4-0003-4000-8000-000000000003', NULL,                                   'Schwalbe Marathon Plus Tire',  'component', 'tires_tubes',       'Schwalbe',     'Marathon Plus 700x28',   'Puncture-resistant touring tire. Used for one tour, still has good tread.',                  'good',  'stored',  '{sellable,donatable}',      18,   NULL,  NULL,           'Shelf',        '6_to_12_months', 800, 'km', (now() - interval '200 days')::date, 'b0000001-0001-4000-8000-000000000003', 'all', now() - interval '7 days', now() - interval '1 day');

-- Jonas items (touring cyclist)
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage_km, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ('d0000001-0001-4000-8000-000000000004', 'a1b2c3d4-0004-4000-8000-000000000004', 'c0000001-0001-4000-8000-000000000004', 'Tubus Logo Rear Rack',         'component', 'racks',             'Tubus',        'Logo Classic',           'Stainless steel rear rack. Rated for 40kg. Bombproof.',                                     'good',  'mounted', '{borrowable}',              NULL, 25,   '1_month',      NULL,           '3_to_5_years', 15000, 'km', (now() - interval '1200 days')::date, 'b0000001-0001-4000-8000-000000000004', 'all', now() - interval '60 days', now() - interval '20 days'),
  ('d0000001-0002-4000-8000-000000000004', 'a1b2c3d4-0004-4000-8000-000000000004', NULL,                                   'Ortlieb Back-Roller Classic',  'accessory', 'bags_panniers',     'Ortlieb',      'Back-Roller Classic',    'Pair of waterproof panniers. 40L total. Some scratches but fully waterproof.',              'worn',  'stored',  '{borrowable,sellable}',     50,   15,   '2_weeks',      'Garage',       '3_to_5_years', NULL, NULL, (now() - interval '1000 days')::date, 'b0000001-0001-4000-8000-000000000004', 'all', now() - interval '30 days', now() - interval '5 days'),
  ('d0000001-0003-4000-8000-000000000004', 'a1b2c3d4-0004-4000-8000-000000000004', NULL,                                   'Wahoo ELEMNT Bolt V2',         'accessory', 'computers',         'Wahoo',        'ELEMNT Bolt V2',         'GPS bike computer with color screen. Selling because I upgraded to Roam.',                  'good',  'stored',  '{sellable}',                120,  NULL,  NULL,           'Desk',         '1_to_2_years', NULL, NULL, (now() - interval '400 days')::date, 'b0000001-0001-4000-8000-000000000004', 'all', now() - interval '3 days',  now() - interval '3 days'),
  ('d0000001-0004-4000-8000-000000000004', 'a1b2c3d4-0004-4000-8000-000000000004', 'c0000001-0001-4000-8000-000000000004', 'Brooks B17 Saddle',            'component', 'seatposts_saddles', 'Brooks',       'B17 Standard',           'Broken in perfectly over 10000km. Leather is supple but still supportive.',                 'worn',  'mounted', '{private}',                 NULL, NULL,  NULL,           NULL,           '5_plus_years', 10000, 'km', (now() - interval '1800 days')::date, 'b0000001-0001-4000-8000-000000000004', 'private', now() - interval '90 days', now() - interval '30 days'),
  ('d0000001-0005-4000-8000-000000000004', 'a1b2c3d4-0004-4000-8000-000000000004', NULL,                                   'Topeak Joe Blow Sport III',    'tool',      'pumps',             'Topeak',       'Joe Blow Sport III',     'Floor pump with TwinHead. Up to 160psi. Gauge works perfectly.',                            'good',  'stored',  '{borrowable}',              NULL, 10,   '1_week',       'Garage',       '3_to_5_years', NULL, NULL, (now() - interval '900 days')::date, 'b0000001-0001-4000-8000-000000000004', 'all', now() - interval '45 days', now() - interval '15 days');

-- Lisa items (gravel racer)
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage_km, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ('d0000001-0001-4000-8000-000000000005', 'a1b2c3d4-0005-4000-8000-000000000005', 'c0000001-0001-4000-8000-000000000005', 'Shimano GRX RD-RX812',         'component', 'drivetrain',        'Shimano',      'GRX RX812',              'GRX rear derailleur, 1x11 clutch type. Low mileage, upgrading to Di2.',                     'good',  'stored',  '{sellable}',                85,   NULL,  NULL,           'Workbench',    '6_to_12_months', 1200, 'km', (now() - interval '250 days')::date, 'b0000001-0001-4000-8000-000000000005', 'all', now() - interval '12 days', now() - interval '2 days'),
  ('d0000001-0002-4000-8000-000000000005', 'a1b2c3d4-0005-4000-8000-000000000005', NULL,                                   'Vittoria Terreno Dry Tires',   'component', 'tires_tubes',       'Vittoria',     'Terreno Dry 700x38',     'Fast-rolling gravel tires. Used for one race season.',                                      'good',  'stored',  '{sellable,borrowable}',     30,   10,   '2_weeks',      'Shelf',        '6_to_12_months', 1500, 'km', (now() - interval '200 days')::date, 'b0000001-0001-4000-8000-000000000005', 'all', now() - interval '8 days',  now() - interval '3 days'),
  ('d0000001-0003-4000-8000-000000000005', 'a1b2c3d4-0005-4000-8000-000000000005', NULL,                                   'Silca T-Ratchet Torque Kit',   'tool',      'torque_wrenches',   'Silca',        'T-Ratchet',              'Compact torque wrench with Ti bits. Essential for carbon components.',                      'good',  'stored',  '{borrowable}',              NULL, 20,   '3 days',       'Tool case',    '1_to_2_years', NULL, NULL, (now() - interval '350 days')::date, 'b0000001-0001-4000-8000-000000000005', 'all', now() - interval '18 days', now() - interval '6 days'),
  ('d0000001-0004-4000-8000-000000000005', 'a1b2c3d4-0005-4000-8000-000000000005', 'c0000001-0002-4000-8000-000000000005', 'Shimano Ultegra RD-R8000',     'component', 'drivetrain',        'Shimano',      'Ultegra R8000 SS',       'Short cage rear derailleur. Works perfectly, upgrading to Di2.',                             'good',  'stored',  '{sellable}',                55,   NULL,  NULL,           'Workbench',    '2_to_3_years', 4000, 'km', (now() - interval '600 days')::date, 'b0000001-0001-4000-8000-000000000005', 'all', now() - interval '5 days',  now() - interval '5 days');
...
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage_km, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ...
  ('d0000001-0002-4000-8000-000000000006', 'a1b2c3d4-0006-4000-8000-000000000006', NULL,                                   'Crankbrothers Stamp 7 Pedals', 'component', 'pedals',            'Crankbrothers','Stamp 7 Large',          'Large platform pedals. Great grip, thin profile. Some scratches from rocks.',                'worn',  'stored',  '{sellable,donatable}',      35,   NULL,  NULL,           'Workbench',    '1_to_2_years', NULL, NULL, (now() - interval '350 days')::date, 'b0000001-0001-4000-8000-000000000006', 'all', now() - interval '20 days', now() - interval '7 days'),
  ('d0000001-0003-4000-8000-000000000006', 'a1b2c3d4-0006-4000-8000-000000000006', NULL,                                   'Leatt DBX 4.0 Knee Pads',     'accessory', 'protection',        'Leatt',        'DBX 4.0',                'Slim knee pads with 3DF AirFit impact foam. Size L. Very breathable.',                      'good',  'stored',  '{borrowable}',              NULL, 10,   '1_week',       'Closet',       '1_to_2_years', NULL, NULL, (now() - interval '300 days')::date, 'b0000001-0001-4000-8000-000000000006', 'all', now() - interval '12 days', now() - interval '4 days'),
  ('d0000001-0004-4000-8000-000000000006', 'a1b2c3d4-0006-4000-8000-000000000006', 'c0000001-0002-4000-8000-000000000006', 'Maxxis Assegai Tire',          'component', 'tires_tubes',       'Maxxis',       'Assegai 29x2.5 WT',     'DH casing, MaxxGrip compound. Mega grip in wet. Heavy but worth it.',                       'good',  'mounted', '{private}',                 NULL, NULL,  NULL,           NULL,           '6_to_12_months', 800, 'km', (now() - interval '180 days')::date, 'b0000001-0001-4000-8000-000000000006', 'groups', now() - interval '8 days', now() - interval '2 days'),
  ('d0000001-0005-4000-8000-000000000006', 'a1b2c3d4-0006-4000-8000-000000000006', NULL,                                   'Stan''s NoTubes Sealant',      'consumable','tyre_sealant',      'Stan''s',      'NoTubes 32oz',           'About 2/3 bottle remaining. Fresh batch from last month.',                                  'good',  'stored',  '{donatable}',               NULL, NULL,  NULL,           'Shelf',        'under_6_months', NULL, NULL, (now() - interval '60 days')::date, 'b0000001-0001-4000-8000-000000000006', 'all', now() - interval '5 days', now() - interval '2 days');

-- Nina items (MTB trail/XC)
INSERT INTO items (id, owner_id, bike_id, name, category, subcategory, brand, model, description, condition, status, availability_types, price, deposit, borrow_duration, storage_location, age, usage_km, usage_unit, purchase_date, pickup_location_id, visibility, created_at, updated_at) VALUES
  ('d0000001-0001-4000-8000-000000000007', 'a1b2c3d4-0007-4000-8000-000000000007', 'c0000001-0001-4000-8000-000000000007', 'RockShox SID Ultimate Fork',   'component', 'suspension',        'RockShox',     'SID Ultimate 120mm',     '29er, 120mm travel. Charger Race Day damper. Switching to longer travel.',                   'good',  'stored',  '{sellable}',                350,  NULL,  NULL,           'Garage',       '6_to_12_months', 2000, 'km', (now() - interval '200 days')::date, 'b0000001-0001-4000-8000-000000000007', 'all', now() - interval '10 days', now() - interval '2 days'),
  ('d0000001-0002-4000-8000-000000000007', 'a1b2c3d4-0007-4000-8000-000000000007', NULL,                                   'SRAM Eagle XX1 Cassette',      'component', 'drivetrain',        'SRAM',         'XX1 Eagle 10-52T',       '12-speed XD cassette. Some wear on smaller cogs but shifts perfectly.',                      'worn',  'stored',  '{sellable}',                80,   NULL,  NULL,           'Workbench',    '1_to_2_years', 3000, 'km', (now() - interval '400 days')::date, 'b0000001-0001-4000-8000-000000000007', 'all', now() - interval '15 days', now() - interval '5 days'),
